...
CytronMD motor_left(PWM_PWM, 3, 2);   // PWM 1A = Pin 3, PWM 1B = Pin 2.
CytronMD motor_right(PWM_PWM, 5, 4);   // PWM 2A = Pin 5, PWM 2B = Pin 4.
...
float count_per_rev_lm = 40.0;// <======== set this number according to your motor (count per rev) for left motor

float count_per_rev_rm = 40.0;// <======== set this number according to your motor (count per rev) for right motor
...
double LM_kp = 0.08, LM_ki = 1.0 , LM_kd = 0.00000;          // modify for optimal performance
...
double RM_kp = 0.08, RM_ki = 1.0 , RM_kd = 0.00000;          // modify for optimal performance
